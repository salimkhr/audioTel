            ...
            if($(".dateSlider").length > 0){
                $(".dateSlider").each(function(){
                    $(this).dateRangeSlider({
                        bounds: {min: new Date(2012, 1, 1), max: new Date()},
                    ...
                    }).ditRangeSlider({type: "date"})
                        .bind("valuesChanged", function(e, data){
                            $("#periode").attr("data-min",data.values.min.getTime()).attr("data-max",data.values.max.getTime());
                        });
                });
    ...
    var templatePlugins = function(){
        ...
        var tp_date = function(){
            ...
            if($(".plugin-date").length > 0){
                ...
                $(".plugin-date").html(day+" "+date+" "+month+" "+year);
            }
